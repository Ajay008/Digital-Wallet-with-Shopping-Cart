<html>
    ...
    <body>
        ...
        <center><img src="images/keyboard.png" class="img-rounded img-responsive" alt="Keyboard" style="height:240px;">
        <br/> <br/> <br/>
        Price : &#8377; <%=session.getAttribute("pricekeyBoard1").toString()%> <br/> <br/>
        Available : <span id="itemAvail"> <%=session.getAttribute("availablekeyBoard1").toString()%> </span> <br/> <br/>
    ...
    <script>
        ...
        <%
            Object item = session.getAttribute("keyboard");
            if(item==null)
                item=0;
