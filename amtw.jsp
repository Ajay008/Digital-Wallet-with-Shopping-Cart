                 ...
                 <section class="wrapper">
                    ...
                    <div class="row" style="margin-top:115px;">
                        ...
                        <div class="col-sm-6" style="border-right:0px solid #999da3; padding-left:60px; padding-right:60px;">
                            <h4 style="text-decoration:none; font-size:2em;"> <center> Add Money to Wallet </center> </h4>
                            <br/>
                            <form action="amtw2" method="post" onsubmit="return addMoneyValidate()">
                                ...
                                <input type="number" id="amount0" name="amount0" placeholder="Enter amount to be added to wallet" class="form-control" min="10" max="50000" required> <br/>
                                <center>
                                    <input type="submit" value="Add money to Wallet" id="addMoneyButton" class="btn" style="background-color:#68dff0;">
                                </center>
                            </form>
                            <br/> <br/> <br/>
                        </div>
                         ...
                         <div class="col-sm-6" style="border-left:1px solid #999da3; padding-left:50px; padding-right:50px; min-height:350px;">
                             ...
                             <br/>          
                             <form action="addCard?srcPage=amtw" method="post" onsubmit="return validateCard()">
    ...
    <script>
        $(document).ready(function(){
           $("#transactionsA").trigger('click'); 
            $("#amtwA").addClass("active");
        });
        
        
        function addMoneyValidate()
        {
