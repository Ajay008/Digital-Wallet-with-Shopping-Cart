        ...
        <div class="row" style="margin-top:150px;">
            ...
            <div class="col-sm-4" style="border:1px solid #FFC300; border-radius:5px;">
                ...
                <form action="forgot2" method="post" >
                    ...
                    <input type="text" name="userId" placeholder="Enter your User Id (Email-Id) : " class="form-control" required> <br/>
                    <input type="date" name="dob" placeholder="Enter registered date of birth" class="form-control" required> 
        ...
        $("#logoutDiv").css("visibility","hidden");
         ...
         <%
            ...
            if(request.getAttribute("message")!=null)
            {
                ...
                String tempString = "<p style='border:0.5px solid #B80000;'>"+message+"</p>";
                out.println("$('#message').html(\""+tempString+"\");");
            }
        %>
